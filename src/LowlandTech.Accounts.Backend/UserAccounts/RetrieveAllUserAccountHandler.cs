...
public sealed class RetrieveAllUserAccountHandler : IRequestHandler<RetrieveAllUserAccountRequest, RetrieveAllUserAccountResponse>
{
    private readonly IDbContextFactory<AccountsContext> _factory;
    public RetrieveAllUserAccountHandler(IDbContextFactory<AccountsContext> factory) => _factory = factory;

    public async Task<RetrieveAllUserAccountResponse> Handle(RetrieveAllUserAccountRequest req, CancellationToken cancellationToken = default)
    {
        await using var db = await _factory.CreateDbContextAsync(cancellationToken);
        var q = db.Set<UserAccount>().AsNoTracking();
        ...
        return new RetrieveAllUserAccountResponse
        {
